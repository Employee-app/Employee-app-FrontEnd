...
const GddVoteThirdPage = ({navigation,route}) => {
    const [checked, setChecked] = useState('MSC')
            ...
            <View>
                <View style={{flexDirection:'row'}}>
                  ...
                  <View style={{flexDirection: 'row'}}>
                      <RadioButton
                        value = 'MSC'
                        status = {checked === 'MSC' ? 'checked': 'unchecked'}
                        onPress = {() => setChecked('MSC')}
                    />
                        ...
                        <View style = {{flexDirection:'row'}}>
                            ...
                            />
                            <Text style={{margin: 10}}>Mariah Sofia Carey</Text> 
                        </View>
                  </View> 
                ...
                <View style={{flexDirection:'row'}}>
                    ...
                    <View  style={{flexDirection: 'row'}}>
                       <RadioButton
                        value = 'EDA'
                        status = {checked === 'EDA' ? 'checked': 'unchecked'}
                        onPress = {() => setChecked('EDA')}
                    />
                            ...
                            />
                            <Text style={{margin: 10}}>Esther Dansoah Asamoah</Text> 
                            </View> 
                    </View>
...
export default GddVoteThirdPage
